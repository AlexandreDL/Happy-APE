 ...
 */
final class Version20190730152024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media DROP news_id, CHANGE event_id event_id INT DEFAULT NULL, CHANGE private_post_id private_post_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media ADD news_id INT DEFAULT NULL, CHANGE event_id event_id INT DEFAULT NULL, CHANGE private_post_id private_post_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
