 ...
 */
final class Version20190725175524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media ADD event VARCHAR(255) DEFAULT NULL, DROP event_id, CHANGE accreditation_level_id accreditation_level_id INT DEFAULT NULL, CHANGE news_id news_id INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON DEFAULT NULL, CHANGE adress_city adress_city VARCHAR(255) DEFAULT NULL, CHANGE address_city address_city VARCHAR(255) DEFAULT NULL, CHANGE address_street address_street VARCHAR(255) DEFAULT NULL, CHANGE address_other address_other VARCHAR(255) DEFAULT NULL, CHANGE address_number address_number VARCHAR(255) DEFAULT NULL, CHANGE address_zipcode address_zipcode VARCHAR(255) DEFAULT NULL, CHANGE newsletter_subscription newsletter_subscription TINYINT(1) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE media ADD event_id INT DEFAULT NULL, DROP event, CHANGE accreditation_level_id accreditation_level_id INT DEFAULT NULL, CHANGE news_id news_id INT DEFAULT NULL, CHANGE url url VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
